...
let authorName = "Álex (Arsen González)";
...
'<li style="list-style: none; margin-left: auto; text-align: right;"><img src="images/logo.png" width="30"></li></ul>' ;
...
let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://pages.github.com/.org/'>Github Pages</a>. Website wallpaper by <a href='https://www.instagram.com/ryankim_photography/'>Ryan Kim</a>.</p>";
